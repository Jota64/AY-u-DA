...
public:
   ...
   */
  std::pair<size_t, unsigned> compute_vertical_seam() const noexcept;
   ...
   */
  std::pair<std::vector<size_t>, unsigned> compute_vertical_seams() const noexcept;
   ...
   */
  static std::vector<std::vector<Color>> min_seam_to_colors(const std::vector<std::vector<Color>>& pixels, size_t min_end_j) noexcept;
   ...
   */
  static std::vector<std::vector<Color>> min_seams_to_colors(const std::vector<std::vector<Color>>& pixels, const std::vector<size_t>& seam_cols) noexcept;
