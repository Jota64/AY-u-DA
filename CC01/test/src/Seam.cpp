...
struct Data
{
  ...
  static const pair<size_t, unsigned> expected_vertical_seam;
  static const pair<vector<size_t>, unsigned> expected_vertical_seams;
};
...
const pair<size_t, unsigned> Data::expected_vertical_seam = make_pair(3, 134679);
const pair<vector<size_t>, unsigned> Data::expected_vertical_seams = make_pair(vector<size_t>{2, 3, 3}, 134679);
